-- Aktif kullanım (son 15 dk heartbeat) varken başka cihaz engelli.
-- Tarayıcı kapanıp çıkış yapılmadan kalan oturumlar 15 dk sonra yeni girişe izin verir.
...
BEGIN
  ...
  IF FOUND THEN
    IF v_active.device_id IS NULL OR v_active.device_id = v_device THEN
      UPDATE public.dealer_sessions
